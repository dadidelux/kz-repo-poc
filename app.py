...
#         "https://api.clevertap.com/1/counts/events.json?req_id=" + count_value + "",
#         headers=headers,
#         data=data,
#     )

#     return event_name, response_f.text
...
#     result = get_clevertap_data(selected_event, start_date, end_date)
#     st.write("EVENT_NAME:", result[0])
#     st.write(result[1])
